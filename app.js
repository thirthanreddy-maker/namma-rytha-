...
const CONFIG = {
  API_BASE_URL: _isNative ? 'https://namma-rytha-backend.onrender.com' : (window.location.hostname === 'localhost' ? 'http://localhost:3000' : 'https://namma-rytha-backend.onrender.com'),
